// import 'package:damasauction/temporary%20files/biddingpage.dart';
// import 'package:damasauction/temporary%20files/profilepage.dart';
...
//         backgroundColor: const Color(0xff358cde), // Orange color
...
import 'package:damasauction/views/ads/ads_add.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // Action for the center button (+)
          Get.to(const ChooseAdCategoryPage());
        },
      ),
    );
  }
